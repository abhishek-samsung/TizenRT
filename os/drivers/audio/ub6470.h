...
#ifndef __DRIVERS_AUDIO_UB6470_H
#define __DRIVERS_AUDIO_UB6470_H
...
#define UB6470_SPK_VOL_MIN         3
#define UB6470_SPK_VOL_MAX         255
#define UB6470_SPK_VOL_DEF         180
#define UB6470_BASS_MAX            100
#define UB6470_TREBLE_MAX          100
...
struct ub6470_dev_s {
	 ...
	 * the UB6470 driver with respect to the board lower half driver).
	 *
	...
	struct audio_lowerhalf_s dev;	/* UB6470 audio lower half (this device) */

	/* Our specific driver data goes here */

	FAR struct ub6470_lower_s *lower;	/* Pointer to the board lower functions */
...
#endif							/* __DRIVERS_AUDIO_UB6470_H */
