...
__EIT_entry *__exidx_start_elf[CONFIG_NUM_APPS];
__EIT_entry *__exidx_end_elf[CONFIG_NUM_APPS];
...
{
	__exidx_start_elf[bin_idx - 1] = (__EIT_entry *)start;
	__exidx_end_elf[bin_idx - 1]   = (__EIT_entry *)end;
...
{
	__EIT_entry * __exidx_start_common = (__EIT_entry *)(&__exidx_start);
	__EIT_entry * __exidx_end_common = (__EIT_entry *)(&__exidx_end);
